...
async function main(){
    ...
    const myKeypair = loadWalletKey("3iTjBcGaFuKo5onvbo6jmT31ZvkKze7tJFy6wDpSNHek.json");
    const mint = new web3.PublicKey("3Fyc3waKBdD36pU6r3kVdyeWPNc4ccUUAEs7CDqwU8jQ");
    ...
    const ourMetadata = { // TODO change those values!
        name: "PIN Meme Token", 
        symbol: "PIN",
        uri: "https://raw.githubusercontent.com/OnlineRenders/CRYPTO/main/PIN_LOGO.png",
    }
    if(INITIALIZE){
        const onChainData = {
            ...ourMetadata,
